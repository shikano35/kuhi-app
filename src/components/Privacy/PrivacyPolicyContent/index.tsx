...
export function PrivacyPolicyContent() {
  return (
    <div className="font-shippori-mincho space-y-8 text-primary/80">
      <p className="font-sans-reading text-sm leading-relaxed">
      ...
      <section>
        ...
        <p className="font-sans-reading mt-2 text-sm leading-relaxed">
      ...
      <section>
        ...
        <p className="font-sans-reading mb-2 text-sm leading-relaxed">
      ...
      <div className="border-t border-border pt-4">
        <p className="font-sans-reading text-xs text-muted-foreground">
          初出掲載日: 2025年12月11日
          <br />
          最終更新日: 2025年12月11日
        </p>
