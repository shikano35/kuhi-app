...
export function LoginForm() {
  ...
  return (
    <div className="bg-background pb-8 pt-4 px-4 shadow sm:rounded-lg sm:px-10">
      ...
      <div className="bg-yellow-50 border-l-2 border-yellow-400 p-2 my-6 max-w-sm mx-auto">
        <div className="flex justify-center">
          <div className="flex-shrink-0">
            <Info className="size-5 text-yellow-400" />
          </div>
          <div className="ml-4">
            <p className="text-sm md:text-base text-yellow-700 text-start">
              現在，句碑情報の投稿のみ可能です。
              <br />
              お気に入り登録は利用できません。
            </p>
      ...
      <div className="mt-4 flex justify-center">
        ...
        >
          <GoogleIcon className="size-5 mr-4 mt-1" />
          Googleでログイン
        </button>
      </div>
