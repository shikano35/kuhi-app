    ...
    <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        {imageUrl ? (
          ...
          <div className="absolute inset-0 bg-linear-to-br from-primary via-primary/90 to-accent-purple" />
        )}
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg md:text-xl text-accent-purple-foreground mb-6">
          {poetName}
        </p>

        {locationText && (
          <div className="flex items-center justify-center gap-2 text-primary-foreground/90 mb-10">
