...
export function HistorySection() {
  return (
    <section
      ...
      className="py-24 px-4 bg-linear-to-br from-background via-muted/30 to-background overflow-hidden"
      role="region"
    >
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-20">
          <h2
            className="text-3xl md:text-4xl font-bold mb-6 bg-linear-to-r from-primary via-purple-600 to-blue-600 bg-clip-text text-transparent"
            id="history-heading"
          >
            俳句と句碑の歴史
          </h2>
        ...
        <div className="relative">
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-linear-to-b from-primary via-purple-500 to-blue-500 hidden md:block" />
          ...
          {HISTORY_EVENTS.map((event, index) => (
            ...
            >
              ...
              <div className="hidden md:flex md:items-center md:justify-center md:w-16 md:h-16 md:relative md:z-20">
                <motion.div
                  className="w-12 h-12 rounded-full bg-linear-to-br from-primary to-purple-600 border-4 border-background shadow-lg flex items-center justify-center"
