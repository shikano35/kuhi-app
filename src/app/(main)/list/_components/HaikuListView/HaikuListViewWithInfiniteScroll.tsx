...
type HaikuListViewWithInfiniteScrollProps = {
...
export function HaikuListViewWithInfiniteScroll({
  initialPoems,
  hasMore,
  onLoadMore,
  isLoading,
}: HaikuListViewWithInfiniteScrollProps) {
  ...
  return (
    ...
    >
      ...
      <div className="text-sm text-muted-foreground">
        {filteredPoems.length}件の俳句が見つかりました
      </div>
